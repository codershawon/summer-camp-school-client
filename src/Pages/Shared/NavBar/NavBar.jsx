...
const NavBar = () => {
    ...
    return (
        <div className='bg-gradient-to-r from-teal-700 to-emerald-900 w-full'>
        <Container>
            <div className="navbar pt-4">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow rounded-box w-52 bg-gray-100">
                            <li><NavLink to="/" ><a>Home</a></NavLink></li>
                            <li><NavLink to="/instructors"><a>Instructors</a></NavLink></li>
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1 ml-0 md:ml-20 text-xl font-semibold">
                        ...
                        <li><NavLink to="/instructors" className="text-gray-300"><a>Instructors</a></NavLink></li>
